...
function scene:createScene(event)
	...
	background1= display.newImage("bg6.jpg",0,0)
	...
	local function Aliens()
		...
		--for i =1,NoOfAliens do
			...
			transition.to( fleet[x], { y = display.contentHeight, time = 20000})
...
function scene:enterScene( event )
	...
	FleetCheck = timer.performWithDelay(700,Damagefleet,0)
