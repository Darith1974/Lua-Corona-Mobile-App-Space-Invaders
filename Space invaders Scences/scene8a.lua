...
local function Platform()
		...
		Platforms[1] = display.newRect( 2*a+10, e-3*d, a+10, c )
		...
		Platforms[3] = display.newRect( 10,e-(9*d), a+10, c )
		...
		Platforms[5] = display.newRect( 2*a+10,e-(15*d), a+10, c )
		...
		Platforms[8] = display.newImage("spacedoor.jpg",a+10,10 )
