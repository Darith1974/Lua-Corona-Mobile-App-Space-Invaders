...
local function Damagefleet()
	...
	if DamageFleetCounter >= 20 then
		...
		DamageFleetCounter = 0
		local options = {effect = "fade", time = 400 }
		storyboard.gotoScene( "scene4f", options)
	end
end
...
function scene:createScene(event)
	...
	background1= display.newImage("bg5.jpg",0,0)
	...
	AlienTimer = timer.performWithDelay(1700, Aliens,0)
...
function scene:enterScene( event )
	...
	FleetCheck = timer.performWithDelay(2700,Damagefleet,0)
